...
sbt -no-colors "Jmh/run -i 5 -wi 5 -f1 -t1 com.ziplex.lexer.benchmark.lexer.AAStarBLexerBenchmarkBig" > "$DIRECTORY_PATH/aa_star_b_lexer_benchmark_big_wi_5_i_5_laraserver4.txt"
