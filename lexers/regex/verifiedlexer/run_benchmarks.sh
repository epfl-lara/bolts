...
sbt -no-colors "Jmh/run -i 5 -wi 5 -f1 -t1 com.ziplex.lexer.benchmark.maps.MutableHashMapBenchmarkBig" > "$DIRECTORY_PATH/hashmaps_benchmark_wi_5_i_5_laraserver4.txt"
