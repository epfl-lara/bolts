...
python3 extract_to_coqlex.py ./latest/json_lexer_benchmark_wi_5_i_5_laraserver4.txt ./latest/json_lexer_benchmark_wi_5_i_5_graal.txt ./from_coqlex/Comparison/JSON/results/CoqLex ./from_coqlex/Comparison/JSON/results/
