...
def add_plot(js, name):
    ...
    if(name == 'ocamllex'):
        p = axis.plot(fxs,fys, color='orange',label = name)
    elif(name == 'flex'):
        p = axis.plot(fxs,fys, color='red',label = name)
    elif(name == 'CoqLex'):
        p = axis.plot(fxs,fys, color='darkgreen',label = name)
    elif(name == 'Verbatim'):
        p = axis.plot(fxs,fys, color='gray',label = name)
    elif(name == 'VerbatimSt'):
        p = axis.plot(fxs,fys, color='purple',label = name)
    elif(name == 'VerbatimSt'):
        p = axis.plot(fxs,fys, color='olive',label = name)
    else:
...
#add_plot(js, "real")
#for j in js:
#    j["times"][0] = j["times"][0]/2
#add_plot(js, "real 2")


axis.legend(loc='best')
#axis.legend(["real", "real2"])
